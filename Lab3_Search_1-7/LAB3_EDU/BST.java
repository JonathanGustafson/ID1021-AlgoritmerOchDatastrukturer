...
/*
 * this file is taken from: https://algs4.cs.princeton.edu/code/
 * 
 * Minor changes has been done by Jonathan Gustafson
 * 
 */
...
public class BST<Key extends Comparable<Key>, Value> {
    ...
    /*CODE WRITTEN BY JONATHAN GUSTAFSON STARTS HERE */
	public void printAlpha(){
		if(root==null) {
			StdOut.println("tree empty");
			return;
		}
		printAlpha(root);
	}
	
	public void printAlpha(Node node){
		if(node == null)
			return;
	...
	public void printReversedAlpha(){
		if(root==null) {
			StdOut.println("tree empty");
			return;
		}
		printReversedAlpha(root);
	}
	
	public void printReversedAlpha(Node node){
		if(node == null)
			return;
			
		printReversedAlpha(node.right);
		StdOut.println(node.key);
		printReversedAlpha(node.left);

	}
	
	/*CODE WRITTEN BY JONATHAN GUSTAFSON ENDS HERE*/
